...
In [my previous post](Local%20LLMs%20with%20Ollama%201.qmd) I outlined how to set up Ollama and Continue to create a Copilot-like experience entirely local. The main focus of that article was coding, but I have a second usecase for this stack, that is much more exciting.
...
I will assume that you followed all the steps from the [previous post](Local%20LLMs%20with%20Ollama%201.qmd), and have a working Ollama + Continue stack in VSCode, alongside an Obsidian vault you want to talk to.
...
![[Ollama meets Obsidian.png]]


The magic happens in the `@codebase` index:
![[Ollama meets Obsidian-1.png]]
